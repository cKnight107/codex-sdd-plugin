...
在执行本 skill 时，同时遵守 [../../references/full-sdd-lifecycle.md](../../references/full-sdd-lifecycle.md) 中 `spec-fix` 阶段的协同规则。

- 先按本插件 `skills/debugging-and-error-recovery/SKILL.md` 复现和定位
- 再按本插件 `skills/test-driven-development/SKILL.md` 补证明与防回归
- 当修正改变长期决策时，补充本插件 `skills/documentation-and-adrs/SKILL.md` 的沉淀要求
